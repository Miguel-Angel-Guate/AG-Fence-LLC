...
const contactDetails = [
    {
        id: 'description',
        content: `Our deck construction service is designed to transform your outdoor space into an oasis of relaxation and entertainment. We offer a wide range of material options, from natural wood to composite materials and vinyl, to suit your style and maintenance preferences.`
    },
    {
        id: 'telephone',
