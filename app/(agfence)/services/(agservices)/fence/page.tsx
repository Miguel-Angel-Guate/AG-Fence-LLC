...
const contactDetails = [
    {
        id: 'description',
        content: `Our fencing service provides you with high-quality fencing solutions that
                add security, privacy and style to your property. We offer a variety of styles
                and materials to ensure your fence fits the aesthetic of your home and
                provides the protection you desire.`
    },
    {
        id: 'telephone',
        ...
        <>
            ...
            <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-start py-8">
                <div className="lg:w-1/2 p-4">
                    <h2 className="text-2xl font-bold mb-4">Fencing</h2>
